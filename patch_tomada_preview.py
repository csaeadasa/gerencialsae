...
good_vars = """                              let articleCounter = 1;
                              const artEmentaIndex = ementaArticlesFinal.length > 0 ? articleCounter++ : null;
                              const artConsiderandosIndex = considerandosArticlesFinal.length > 0 ? articleCounter++ : null;
                              const art1Index = articlesWithAcrescidos.length > 0 ? articleCounter++ : null;
                              const art2Index = articlesWithAlterados.length > 0 ? articleCounter++ : null;
...
bad_sections = """                                  {/* SEÇÃO 1: ARTIGO DE DISPOSITIVOS ACRESCIDOS */}
...
good_sections = """                                  {/* SEÇÃO 1: ARTIGO DE EMENTA */}
                                  {ementaArticlesFinal.length > 0 && (
                                    <div className="space-y-3 pt-2">
                                      <p className="indent-8">
                                        <strong>Art. {artEmentaIndex}º.</strong> A Ementa da {minutaResolucoesAlteradas} passa a vigorar com a seguinte redação:
...
content = content.replace(bad_sections, good_sections)
