...
const origRows = [
  ...
  ["Serviço", "Serviço referente...", "Texto"],
  ["Descrição", "Descrição da reclamação", "Texto"],
  ["Tipo", "Tipo da reclamação...", "Texto"],
  ["Canal", "Canal de atendimento...", "Texto"]
];

const propRows = [
  ["Protocolo", "Número do protocolo de atendimento", "Texto"],
  ["Descrição", "Descrição da reclamação", "Texto"], 
  ["Tipo Teste", "fdfdfdfd", "fdfdfddfdfd"],
  ["Tipo", "Tipo da reclamação...", "Texto"],
  ["Canal", "Canal de atendimento...", "Texto"]
];
